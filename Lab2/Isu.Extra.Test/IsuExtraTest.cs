...
public class IsuExtraTest
{
    ...
    public IsuExtraTest()
    {
        ...
        superIsuServie.AddNewExtraCourse("CyberBebra", superIsuServie.Megafaculties[0]);
        superIsuServie.AddNewExtraCourse("CyberBebra 2: Uprising", superIsuServie.Megafaculties[0]);
        superIsuServie.AddNewExtraCourse("CyberBebra 3: i am always come back", superIsuServie.Megafaculties[0]);
        superIsuServie.AddNewExtraCourse("figna kakayto", superIsuServie.Megafaculties[1]);
    ...
    public void AddStudentToCGTAOneCourse()
    {
        ...
        Schedule newSchedule1 = Schedule.Builder
                                    ...
                                    .Build();
        superIsuServie.Megafaculties[0].Courses[0].AddNewStream("1", 1, newSchedule1);
        ...
        Schedule newSchedule2 = Schedule.Builder
                                    .AddNewLesson(newCertainLesson1)
                                    .Build();
        superIsuServie.Megafaculties[0].Courses[0].AddNewStream("2", 1, newSchedule2);

        superIsuServie.AddStudentToExtraStudy(superIsuServie.Isu.Students[0], superIsuServie.Megafaculties[0].Courses[0].Streams[0]);
        Assert.ThrowsAny<CGTAStudentException>(() => superIsuServie.AddStudentToExtraStudy(superIsuServie.Isu.Students[0], superIsuServie.Megafaculties[0].Courses[0].Streams[1]));
    }
    ...
    public void AddStudentToCGTADifferentMegafaculy()
    {
        ...
        Schedule newSchedule2 = Schedule.Builder
                                    .AddNewLesson(newCertainLesson1)
                                    .Build();
        superIsuServie.Megafaculties[1].Courses[0].AddNewStream("2", 1, newSchedule2);

        superIsuServie.AddStudentToExtraStudy(superIsuServie.Isu.Students[0], superIsuServie.Megafaculties[0].Courses[0].Streams[0]);
        Assert.ThrowsAny<CGTAStudentException>(() => superIsuServie.AddStudentToExtraStudy(superIsuServie.Isu.Students[0], superIsuServie.Megafaculties[1].Courses[0].Streams[0]));
    }
    ...
    public void AddStudentToCGTAIntersectionWithMainSchedule()
    {
        ...
        Schedule newSchedule = Schedule.Builder
                                    ...
                                    .Build();
        superIsuServie.Megafaculties[0].Courses[0].AddNewStream("1", 1, newSchedule);

        Assert.ThrowsAny<CGTAStudentException>(() => superIsuServie.AddStudentToExtraStudy(superIsuServie.Isu.Students[0], superIsuServie.Megafaculties[0].Courses[0].Streams[0]));
    }
    ...
    public void AddStudentToThreeCGTA()
    {
        ...
        Schedule newSchedule2 = Schedule.Builder
                                    ...
                                    .Build();
        superIsuServie.Megafaculties[0].Courses[1].AddNewStream("1", 1, newSchedule2);
        ...
        Schedule newSchedule3 = Schedule.Builder
                                    ...
                                    .Build();
        superIsuServie.Megafaculties[0].Courses[2].AddNewStream("1", 1, newSchedule3);

        superIsuServie.AddStudentToExtraStudy(superIsuServie.Isu.Students[0], superIsuServie.Megafaculties[0].Courses[0].Streams[0]);
        superIsuServie.AddStudentToExtraStudy(superIsuServie.Isu.Students[0], superIsuServie.Megafaculties[0].Courses[1].Streams[0]);
        Assert.ThrowsAny<CGTAStudentException>(() => superIsuServie.AddStudentToExtraStudy(superIsuServie.Isu.Students[0], superIsuServie.Megafaculties[0].Courses[2].Streams[0]));
    }
}
